...
# ---------------------------------------------------------------------------
PROJECT = nes4pc.exe
OBJFILES = nes4pc.obj main.obj 6502.obj AboutWindowForm.obj \
   OptionsWindowForm.obj Defines.obj States.obj video.obj
RESFILES = nes4pc.res
RESDEPEN = $(RESFILES) main.dfm AboutWindowForm.dfm OptionsWindowForm.dfm
LIBFILES = 
DEFFILE = 
# ---------------------------------------------------------------------------
CFLAG1 = -Od -Hc -w -k -r- -y -v -vi- -c -a4 -b- -w-par -w-inl -Vx -Ve -x -5
