...
//			(GetProcAddress(MapperDllInst,"Unload_DLL"))();
		...
		friend void Map_SetWriteHandler(int Page, PWriteFunc New);
		friend void Map_SetReadHandler(int Page, PReadFunc New);
		friend PWriteFunc Map_GetWriteHandler(int Page);
		friend PReadFunc Map_GetReadHandler(int Page);
		...
		friend unsigned char *	Map_GetPRG_Ptr4(int Where);
		...
		friend unsigned char *	Map_GetCHR_Ptr1(int Where);
		...
		friend void	Map_StatusOut(char *ToSay);
		friend int	Map_GetMenuRoot();
		friend int	Map_AddMenuItem (int root, char *text, int cmd, int parm1, int parm2, int parm3, int mode);
